    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5 max-h-[60vh] overflow-y-auto">
          <form @submit.prevent="updateAnimal" class="space-y-4">
            <!-- First Name Field -->
            ...
            <div>
              ...
              >
              <input
                v-model="props.animal.animalName"
                type="text"
                id="animalName"
            ...
            <div>
              ...
              >
              <input
                v-model="props.animal.animalType"
                type="text"
                id="animaltype"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                required
...
const updateAnimal = async () => {
  const body = {
    ...
    zoo: {
      zooId: props.animal.zoo.zooId,
    },
  };

  try {
    const res = await $fetch(
      `http://localhost:8080/api/animal/update/${props.animal.animalId}`,
      {
        headers: {
...
console.log("Props is", props.animal);
</script>
