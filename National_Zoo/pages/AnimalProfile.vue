          ...
          <div class="grid grid-cols-1">
            <div class="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-lg">
              <div class="flex flex-col items-center pt-6 pr-6 pb-6 pl-6">
                <img
                  src="https://images.unsplash.com/photo-1496436818536-e239445d3327?q=80&w=1200?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;w=500"
                ...
                <p
                  class="mt-3 text-base leading-relaxed text-center text-gray-200"
                >
